"""
Django settings for paysic_38866 project.
...
ROOT_URLCONF = 'paysic_38866.urls'
...
WSGI_APPLICATION = 'paysic_38866.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "paysic_38866 API",
    "DESCRIPTION": "API documentation for paysic_38866 App",
    "VERSION": "v1",
}
